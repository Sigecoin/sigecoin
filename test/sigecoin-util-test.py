...
help_text="""Test framework for sigecoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/sigecoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    sctest.sctester(srcdir + "/test/data", "sigecoin-util-test.json", buildenv)
