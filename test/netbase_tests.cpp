...
{
    BOOST_CHECK(TestSplitHost("sigecoin.net", "sigecoin.net", -1));
    BOOST_CHECK(TestSplitHost("[sigecoin.net]", "sigecoin.net", -1));
    BOOST_CHECK(TestSplitHost("sigecoin.net:80", "sigecoin.net", 80));
    BOOST_CHECK(TestSplitHost("[sigecoin.net]:80", "sigecoin.net", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8560", "127.0.0.1", 8560));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8560", "127.0.0.1", 8560));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8560", "::ffff:127.0.0.1", 8560));
    BOOST_CHECK(TestSplitHost("[::]:8560", "::", 8560));
    BOOST_CHECK(TestSplitHost("::8560", "::8560", -1));
    BOOST_CHECK(TestSplitHost(":8560", "", 8560));
    BOOST_CHECK(TestSplitHost("[]:8560", "", 8560));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8560", "127.0.0.1:8560"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8560", "[::]:8560"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
