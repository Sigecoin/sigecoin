#ifndef __sigeconfig_h__
#define __sigeconfig_h__
...
#define HAVE_FUNC_ATTRIBUTE_DLLEXPORT 0

/* Define to 1 if the system has the `dllimport' function attribute */
#define HAVE_FUNC_ATTRIBUTE_DLLIMPORT 0
...
#define PACKAGE_URL "https://sigecoin.org/"
