...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sigenode-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sigenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sigecoin transaction") + "\n" +
              "  sigenode-tx [options] -create [commands]   " + _("Create hex-encoded sigecoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CSigAddress addr = CSigAddress(base58string(strAddr));
    if (!addr.IsValid())
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sigecoin transaction
