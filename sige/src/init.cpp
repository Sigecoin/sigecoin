 ...
 * between sigenode, and wallet-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SIGECOIN_PID_FILENAME));
#endif
...
/** Sanity checks
 *  Ensure that Sigecoin is running in a usable environment with all
...
bool AppInitParameterInteraction()
{
    ...
    // 1-sige-fee transactions. It should be set above the real
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Sigecoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", SIGECOIN_CONF_FILENAME)).string());
