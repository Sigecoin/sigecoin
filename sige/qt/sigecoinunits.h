...
#ifndef SIGE_QT_SIGECOINUNITS_H
#define SIGE_QT_SIGECOINUNITS_H
...
/** Sigecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SigecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SigecoinUnits(QObject *parent);
    ...
    //! Return maximum number of base units (Siges)
    static CAmount maxMoney();

private:
    QList<SigecoinUnits::Unit> unitlist;
};
typedef SigecoinUnits::Unit SigecoinUnit;

#endif // SIGE_QT_SIGECOINUNITS_H
